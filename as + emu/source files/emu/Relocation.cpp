...
string Relocation::printRelocation() {
	...
	out << setw(15) << hex << (unsigned) offset << setw(15)
			<< section->getName() << setw(15) << symbol->getName() << setw(15)
			<< relativeTo << setw(15) << types[type] << endl;
...
RelocationType Relocation::getReloctionType() {
	return type;
}
